(() => {
  const valid = value => ['michigan','lions','aurora'].includes(value) ? value : 'michigan';
  let theme = 'michigan';
  ...
  const apply = value => {
    ...
    if (meta) meta.content = theme === 'lions' ? '#0076b6' : theme === 'aurora' ? '#091426' : '#00274c';
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    [['michigan','Maize & blue'],['lions','Detroit Lions'],['aurora','Midnight Aurora']].forEach(([value, title]) => {
