(() => {
  ...
  const report = (kind, line = 0) => {
    ...
    if (!csrf || reported >= 5 || !["/dashboard", "/home", "/lineup", "/rosters", "/moves", "/scores", "/trades", "/transactions", "/transactions/pending", "/watchlist", "/compare", "/notifications", "/schedule", "/rules", "/data-status", "/guide"].includes(page)) return;
    reported += 1;
